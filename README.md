# Files, Exceptions & SQL using Python

- [GitHub Repository](https://github.com/hpotluri/datafun-05-data-at-rest/)

In this Project, we will read from data files, process the data, and write to output files. We'll also look at using Python to work with light-weight, files-based relational database SQLite using the sqlite3 module from the Python Standard Library.
